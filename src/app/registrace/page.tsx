      ...
      <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-start">
              <input
                ...
                type="checkbox"
                required
                className="h-4 w-4 accent-green-500 border-white/20 rounded mt-0.5 cursor-pointer"
              />
              <label
                htmlFor="terms"
              ...
              >
                Souhlasím s{" "}
                <Link href="/podminky" className="text-travel-100 hover:text-white transition-colors">
                  podmínkami použití
                </Link>{" "}
                a{" "}
                <Link href="/ochrana" className="text-travel-100 hover:text-white transition-colors">
